...
package imdb.profession_dim_0_1;
 ...
 * @status
 */
public class profession_dim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "profession_dim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(profession_dim.class);
	...
	private final String jobName = "profession_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					profession_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(profession_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_profession_dim = new byte[0];
		static byte[] commonByteArray_IMDB_profession_dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_profession_dim.length) {
					if (length < 1024 && commonByteArray_IMDB_profession_dim.length == 0) {
						commonByteArray_IMDB_profession_dim = new byte[1024];
					} else {
						commonByteArray_IMDB_profession_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_profession_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_profession_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_profession_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_profession_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_profession_dim) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Bstwe6_" + subJobPidCounter.getAndIncrement());
					...
					class BytesLimit65535_tAggregateRow_1_AGGOUT {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tAggregateRow_1_AGGOUT.append("GROUPBYS" + " = " + "[{OUTPUT_COLUMN="
									+ ("category") + ", INPUT_COLUMN=" + ("category") + "}]");
							log4jParamters_tAggregateRow_1_AGGOUT.append(" | ");
...
// ###############################
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"stg_title_principals\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"stg_title_principals\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							if (rs_tDBInput_1.getString(6) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row1.DI_CreatedDate = rs_tDBInput_1.getTimestamp(6);
								} else {
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row1.DI_JobID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 7, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"stg_title_principals\"", "tMysqlInput", "tMap_2", "tMap_2",
								"tMap"
...
// # Output table : 'out2'
							...
							out2_tmp.profession_sk = Numeric.sequence("s202", 1, 1);
							out2_tmp.category = row1.category;
							out2 = out2_tmp;
...
// Start of branch "out2"
						if (out2 != null) {
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "out2", "tMap_2", "tMap_2", "tMap", "tAggregateRow_1_AGGOUT",
							...
							operation_finder_tAggregateRow_1.category = out2.category;
							...
							if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
								...
								operation_result_tAggregateRow_1.category = operation_finder_tAggregateRow_1.category;
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"stg_title_principals\"", "tMysqlInput", "tMap_2", "tMap_2", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`profession_sk` INT(0)  ,`category` VARCHAR(255)  ,`DI_CreatedDtae` DATETIME  not null ,`DI_JobID` VARCHAR(15)   not null ,primary key(`profession_sk`))");
					if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "dim_profession"
						+ "` (`profession_sk`,`category`,`DI_CreatedDtae`,`DI_JobID`) VALUES (?,?,?,?)";
...
// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.category = aggregated_row_tAggregateRow_1.category;
...
// # Output table : 'out1'
						...
						out1_tmp.profession_sk = Numeric.sequence("s201", 1, 1);
						out1_tmp.category = row2.category;
...
// Start of branch "out1"
					if (out1 != null) {
						...
						if (out1.profession_sk == null) {
							pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
						} else {
							pstmt_tDBOutput_1.setInt(1, out1.profession_sk);
						}

						if (out1.category == null) {
							pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(2, out1.category);
						}
...
// ###############################      
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "nGpQuq_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final profession_dim profession_dimClass = new profession_dim();

		int exitCode = profession_dimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'profession_dim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'profession_dim' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_WPOV8JJ9Ee6_WIiIWRIzPA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T10:37:10.927002900Z");
		...
		try {
			...
			java.io.InputStream inContext = profession_dim.class.getClassLoader()
					.getResourceAsStream("imdb/profession_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = profession_dim.class.getClassLoader()
		...
		log.info("TalendJob: 'profession_dim' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : profession_dim");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'profession_dim' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 158680 characters generated by Talend Cloud Data Fabric on the 4 December
 * 2023 at 5:37:10 AM GMT-05:00
 ************************************************************************************************/