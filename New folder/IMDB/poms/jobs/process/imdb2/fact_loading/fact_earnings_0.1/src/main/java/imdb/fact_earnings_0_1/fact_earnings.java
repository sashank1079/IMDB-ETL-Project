...
package imdb.fact_earnings_0_1;
 ...
 * @status
 */
public class fact_earnings implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "fact_earnings.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(fact_earnings.class);
	...
	private final String jobName = "fact_earnings";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					fact_earnings.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(fact_earnings.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_fact_earnings = new byte[0];
		static byte[] commonByteArray_IMDB_fact_earnings = new byte[0];

		public Integer earning_ID;

		public Integer getEarning_ID() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_fact_earnings.length) {
					if (length < 1024 && commonByteArray_IMDB_fact_earnings.length == 0) {
						commonByteArray_IMDB_fact_earnings = new byte[1024];
					} else {
						commonByteArray_IMDB_fact_earnings = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_fact_earnings, 0, length);
				strReturn = new String(commonByteArray_IMDB_fact_earnings, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_fact_earnings, 0, length);
				strReturn = new String(commonByteArray_IMDB_fact_earnings, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_fact_earnings) {

				try {

					int length = 0;

					this.earning_ID = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.earning_ID, dos);
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ucAxCI_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"fact_movie_earnings\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "fact_movie_earnings";
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("fact_movie_earnings")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`earning_ID` INT(0)  ,`movie_id` INT(10)   not null ,`datesk` INT(10)   not null ,`Gross` INT(10)  ,`Total_Gross` INT(10)  ,`DI_CreatedDate` DATETIME ,`DI_JobID` VARCHAR(10)  )");
					if (log.isDebugEnabled())
						log.debug("tDBOutput_1 - " + ("Create") + (" table '") + (tableName_tDBOutput_1)
								+ ("' has succeeded."));
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "fact_movie_earnings"
						+ "` (`earning_ID`,`movie_id`,`datesk`,`Gross`,`Total_Gross`,`DI_CreatedDate`,`DI_JobID`) VALUES (?,?,?,?,?,?,?)";
...
// ###############################
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"tsvrevenuedb\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("QUERY" + " = "
									+ "\"SELECT    `tsvrevenuedb`.`tconst`,    `tsvrevenuedb`.`Date`,    `tsvrevenuedb`.`Rank`,    `tsvrevenuedb`.`Gross`,    `tsvrevenuedb`.`Theaters`,    `tsvrevenuedb`.`Per_Theater`,    `tsvrevenuedb`.`Total_Gross`,    `tsvrevenuedb`.`Days` FROM `tsvrevenuedb`\"");
							log4jParamters_tDBInput_3.append(" | ");
							...
							log4jParamters_tDBInput_3.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("Date") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Rank") + "}, {TRIM="
									+ ("false") + ", SCHEMA_COLUMN=" + ("Gross") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("Theaters") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("Per_Theater") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Total_Gross")
									+ "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("Days") + "}]");
							log4jParamters_tDBInput_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_3", "\"tsvrevenuedb\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbquery_tDBInput_3 = "SELECT \n  `tsvrevenuedb`.`tconst`, \n  `tsvrevenuedb`.`Date`, \n  `tsvrevenuedb`.`Rank`, \n  `tsvrevenuedb`.`Gross`, \n  `t"
						+ "svrevenuedb`.`Theaters`, \n  `tsvrevenuedb`.`Per_Theater`, \n  `tsvrevenuedb`.`Total_Gross`, \n  `tsvrevenuedb`.`Days`\nFROM"
						+ " `tsvrevenuedb`";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							if (rs_tDBInput_3.getString(2) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_3)
									...
									row1.Date = rs_tDBInput_3.getTimestamp(2);
								} else {
						...
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							row1.Rank = routines.system.JDBCUtil.getString(rs_tDBInput_3, 3, false);
						}
						if (colQtyInRs_tDBInput_3 < 4) {
							row1.Gross = null;
						} else {

							row1.Gross = rs_tDBInput_3.getInt(4);
						...
						if (colQtyInRs_tDBInput_3 < 5) {
							...
							row1.Theaters = rs_tDBInput_3.getInt(5);
							if (rs_tDBInput_3.wasNull()) {
								row1.Theaters = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 6) {
							...
							row1.Per_Theater = rs_tDBInput_3.getInt(6);
							if (rs_tDBInput_3.wasNull()) {
								row1.Per_Theater = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 7) {
							...
							row1.Total_Gross = rs_tDBInput_3.getInt(7);
							if (rs_tDBInput_3.wasNull()) {
								row1.Total_Gross = null;
							}
						}
						if (colQtyInRs_tDBInput_3 < 8) {
							...
							row1.Days = rs_tDBInput_3.getInt(8);
							if (rs_tDBInput_3.wasNull()) {
								row1.Days = null;
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_3", "\"tsvrevenuedb\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap"
...
// # Output table : 'out1'
								...
								out1_tmp.earning_ID = Numeric.sequence("s401", 1, 1);
								out1_tmp.movie_id = row2.movie_id;
								out1_tmp.datesk = row3.datesk;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (out1.earning_ID == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, out1.earning_ID);
							}

							pstmt_tDBOutput_1.setInt(2, out1.movie_id);

							pstmt_tDBOutput_1.setInt(3, out1.datesk);
							...
							if (out1.Total_Gross == null) {
								...
								pstmt_tDBOutput_1.setInt(5, out1.Total_Gross);
							}
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_3", "\"tsvrevenuedb\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "P1tDLs_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row2.movie_id = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 2) {
							...
							row2.tconst = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row2.run_time = null;
						} else {

							row2.run_time = rs_tDBInput_1.getInt(3);
							if (rs_tDBInput_1.wasNull()) {
								row2.run_time = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							...
							row2.rating = rs_tDBInput_1.getDouble(4);
							if (rs_tDBInput_1.wasNull()) {
								row2.rating = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							...
							row2.no_of_votes = rs_tDBInput_1.getInt(5);
							if (rs_tDBInput_1.wasNull()) {
								row2.no_of_votes = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row2.title_sk = rs_tDBInput_1.getInt(6);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row2.WorldWideGross = rs_tDBInput_1.getInt(7);
							if (rs_tDBInput_1.wasNull()) {
								row2.WorldWideGross = null;
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row2.release_year = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							if (rs_tDBInput_1.getString(9) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row2.DI_CreatedDate = rs_tDBInput_1.getTimestamp(9);
								} else {
						...
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							row2.DI_JobID = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_1", "\"fact_movie\"", "tMysqlInput", "tAdvancedHash_row2",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_1", "\"fact_movie\"", "tMysqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "mvh2xn_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"date_dimension\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("QUERY" + " = "
									+ "\"SELECT    `date_dimension`.`datesk`,    `date_dimension`.`date`,    `date_dimension`.`Day`,    `date_dimension`.`Month_Str`,    `date_dimension`.`Season`,    `date_dimension`.`Year`,    `date_dimension`.`DI_CreatedDate`,    `date_dimension`.`DI_JobID` FROM `date_dimension`\"");
							log4jParamters_tDBInput_2.append(" | ");
							...
							log4jParamters_tDBInput_2.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("false") + ", SCHEMA_COLUMN=" + ("Month_Str") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("Season") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
									+ ("Year") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DI_CreatedDate")
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_2", "\"date_dimension\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbquery_tDBInput_2 = "SELECT \n  `date_dimension`.`datesk`, \n  `date_dimension`.`date`, \n  `date_dimension`.`Day`, \n  `date_dimension`.`Month_"
						+ "Str`, \n  `date_dimension`.`Season`, \n  `date_dimension`.`Year`, \n  `date_dimension`.`DI_CreatedDate`, \n  `date_dimension"
						+ "`.`DI_JobID`\nFROM `date_dimension`";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row3.datesk = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row3.Day = rs_tDBInput_2.getInt(3);
							if (rs_tDBInput_2.wasNull()) {
								row3.Day = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							row3.Month_Str = routines.system.JDBCUtil.getString(rs_tDBInput_2, 4, false);
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							row3.Season = null;
						} else {

							row3.Season = routines.system.JDBCUtil.getString(rs_tDBInput_2, 5, false);
						}
						if (colQtyInRs_tDBInput_2 < 6) {
							row3.Year = null;
						} else {

							row3.Year = rs_tDBInput_2.getInt(6);
							if (rs_tDBInput_2.wasNull()) {
								row3.Year = null;
							}
						}
						if (colQtyInRs_tDBInput_2 < 7) {
							...
							if (rs_tDBInput_2.getString(7) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_2)
										&& !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
									row3.DI_CreatedDate = rs_tDBInput_2.getTimestamp(7);
								} else {
						...
						if (colQtyInRs_tDBInput_2 < 8) {
							...
							row3.DI_JobID = routines.system.JDBCUtil.getString(rs_tDBInput_2, 8, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_2", "\"date_dimension\"", "tMysqlInput", "tAdvancedHash_row3",
						...
						row3_HashRow.datesk = row3.datesk;

						row3_HashRow.date = row3.date;

						row3_HashRow.Day = row3.Day;

						row3_HashRow.Month_Str = row3.Month_Str;

						row3_HashRow.Season = row3.Season;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_2", "\"date_dimension\"", "tMysqlInput", "tAdvancedHash_row3", "tAdvancedHash_row3",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "iJTFlZ_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final fact_earnings fact_earningsClass = new fact_earnings();

		int exitCode = fact_earningsClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'fact_earnings' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'fact_earnings' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_jxergJL1Ee6_WIiIWRIzPA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T23:14:02.580897600Z");
		...
		try {
			...
			java.io.InputStream inContext = fact_earnings.class.getClassLoader()
					.getResourceAsStream("imdb/fact_earnings_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = fact_earnings.class.getClassLoader()
		...
		log.info("TalendJob: 'fact_earnings' - Started.");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : fact_earnings");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'fact_earnings' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 228450 characters generated by Talend Cloud Data Fabric on the 4 December
 * 2023 at 6:14:02 PM GMT-05:00
 ************************************************************************************************/