...
package imdb.genre_movie_bridge_0_1;
...
/**
 * Job: genre_movie_bridge Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class genre_movie_bridge implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "genre_movie_bridge.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(genre_movie_bridge.class);
	...
	private final String jobName = "genre_movie_bridge";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					genre_movie_bridge.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(genre_movie_bridge.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row4Struct implements routines.system.IPersistableRow<row4Struct> {
		final static byte[] commonByteArrayLock_IMDB_genre_movie_bridge = new byte[0];
		static byte[] commonByteArray_IMDB_genre_movie_bridge = new byte[0];
		...
		public Integer genre_bridge_sk;

		public Integer getGenre_bridge_sk() {
			return this.genre_bridge_sk;
		}

		public Boolean genre_bridge_skIsNullable() {
			return true;
		}

		public Boolean genre_bridge_skIsKey() {
			return true;
		}

		public Integer genre_bridge_skLength() {
			return null;
		}

		public Integer genre_bridge_skPrecision() {
			return null;
		}

		public String genre_bridge_skDefault() {

			return null;

		}

		public String genre_bridge_skComment() {

			return "";

		}

		public String genre_bridge_skPattern() {

			return "";

		}

		public String genre_bridge_skOriginalDbColumnName() {

			return "genre_bridge_sk";
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.genre_bridge_sk == null) ? 0 : this.genre_bridge_sk.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.genre_bridge_sk == null) {
				if (other.genre_bridge_sk != null)
					return false;

			} else if (!this.genre_bridge_sk.equals(other.genre_bridge_sk))
		...
		public void copyDataTo(row4Struct other) {
			...
			other.genre_bridge_sk = this.genre_bridge_sk;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_genre_movie_bridge.length) {
					if (length < 1024 && commonByteArray_IMDB_genre_movie_bridge.length == 0) {
						commonByteArray_IMDB_genre_movie_bridge = new byte[1024];
					} else {
						commonByteArray_IMDB_genre_movie_bridge = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_genre_movie_bridge, 0, length);
				strReturn = new String(commonByteArray_IMDB_genre_movie_bridge, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_genre_movie_bridge, 0, length);
				strReturn = new String(commonByteArray_IMDB_genre_movie_bridge, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_genre_movie_bridge) {

				try {

					int length = 0;

					this.genre_bridge_sk = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.genre_bridge_sk, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("genre_bridge_sk=" + String.valueOf(genre_bridge_sk));
		...
		public String toLogString() {
			...
			if (genre_bridge_sk == null) {
				sb.append("<null>");
			} else {
				sb.append(genre_bridge_sk);
			}
		...
		public int compareTo(row4Struct other) {
			...
			returnValue = checkNullsAndCompare(this.genre_bridge_sk, other.genre_bridge_sk);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "v4zoAb_" + subJobPidCounter.getAndIncrement());
					...
					class BytesLimit65535_tAggregateRow_1_AGGOUT {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tAggregateRow_1_AGGOUT.append("GROUPBYS" + " = " + "[{OUTPUT_COLUMN="
									+ ("genre_bridge_sk") + ", INPUT_COLUMN=" + ("genre_bridge_sk")
									+ "}, {OUTPUT_COLUMN=" + ("genre_sk") + ", INPUT_COLUMN=" + ("genre_sk")
									+ "}, {OUTPUT_COLUMN=" + ("movie_sk") + ", INPUT_COLUMN=" + ("movie_sk")
									+ "}, {OUTPUT_COLUMN=" + ("tconst") + ", INPUT_COLUMN=" + ("tconst")
									+ "}, {OUTPUT_COLUMN=" + ("primaryTitle") + ", INPUT_COLUMN=" + ("primaryTitle")
									+ "}, {OUTPUT_COLUMN=" + ("genres") + ", INPUT_COLUMN=" + ("genres") + "}]");
							log4jParamters_tAggregateRow_1_AGGOUT.append(" | ");
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result
									+ ((this.genre_bridge_sk == null) ? 0 : this.genre_bridge_sk.hashCode());
...
// ###############################
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"stg_title_basics_genres\"");
							log4jParamters_tDBInput_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_3", "\"stg_title_basics_genres\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row1.genres = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
						if (colQtyInRs_tDBInput_3 < 3) {
							...
							if (rs_tDBInput_3.getString(3) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_3)
									...
									row1.DI_CreatedDate = rs_tDBInput_3.getTimestamp(3);
								} else {
						...
						if (colQtyInRs_tDBInput_3 < 4) {
							...
							row1.DI_JobID = routines.system.JDBCUtil.getString(rs_tDBInput_3, 4, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_3", "\"stg_title_basics_genres\"", "tMysqlInput", "tMap_1",
								"tMap_1", "tMap"
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.genres = row1.genres;
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.genres = '" +
							// row2HashKey.genres + "'");
						} // G 071
...
// # Output table : 'out1'
								...
								out1_tmp.genre_bridge_sk = Numeric.sequence("s41", 1, 1);
								out1_tmp.genre_sk = row2.genre_sk;
								out1_tmp.movie_sk = row3.movie_sk;
								out1_tmp.tconst = row3.tconst;
								out1_tmp.primaryTitle = row3.primaryTitle;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							operation_finder_tAggregateRow_1.genre_bridge_sk = out1.genre_bridge_sk;
							operation_finder_tAggregateRow_1.genre_sk = out1.genre_sk;
							operation_finder_tAggregateRow_1.movie_sk = out1.movie_sk;
							operation_finder_tAggregateRow_1.tconst = out1.tconst;
							operation_finder_tAggregateRow_1.primaryTitle = out1.primaryTitle;
							operation_finder_tAggregateRow_1.genres = out1.genres;
							...
							if (operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
								...
								operation_result_tAggregateRow_1.genre_bridge_sk = operation_finder_tAggregateRow_1.genre_bridge_sk;
								operation_result_tAggregateRow_1.genre_sk = operation_finder_tAggregateRow_1.genre_sk;
								...
								operation_result_tAggregateRow_1.primaryTitle = operation_finder_tAggregateRow_1.primaryTitle;
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_3", "\"stg_title_basics_genres\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`genre_bridge_sk` INT(0)  ,`genre_sk` INT(10)   not null ,`movie_sk` INT(10)   not null ,`tconst` VARCHAR(10)   not null ,`primaryTitle` VARCHAR(1024)  ,`genres` VARCHAR(255)  ,primary key(`genre_bridge_sk`))");
					if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "genre_movie_bridge"
						+ "` (`genre_bridge_sk`,`genre_sk`,`movie_sk`,`tconst`,`primaryTitle`,`genres`) VALUES (?,?,?,?,?,?)";
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row4.genre_bridge_sk = aggregated_row_tAggregateRow_1.genre_bridge_sk;

					row4.genre_sk = aggregated_row_tAggregateRow_1.genre_sk;

					row4.movie_sk = aggregated_row_tAggregateRow_1.movie_sk;

					row4.tconst = aggregated_row_tAggregateRow_1.tconst;

					row4.primaryTitle = aggregated_row_tAggregateRow_1.primaryTitle;

					row4.genres = aggregated_row_tAggregateRow_1.genres;
					...
					if (row4.genre_bridge_sk == null) {
						pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
					} else {
						pstmt_tDBOutput_1.setInt(1, row4.genre_bridge_sk);
					}

					pstmt_tDBOutput_1.setInt(2, row4.genre_sk);
					...
					if (row4.tconst == null) {
						...
						pstmt_tDBOutput_1.setString(4, row4.tconst);
					}

					if (row4.primaryTitle == null) {
						pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(5, row4.primaryTitle);
					}

					if (row4.genres == null) {
						pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
					} else {
						pstmt_tDBOutput_1.setString(6, row4.genres);
					}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "e1kxwT_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"genre_dim\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"genre_dim\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row2.genre_sk = rs_tDBInput_1.getInt(1);
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_1", "\"genre_dim\"", "tMysqlInput", "tAdvancedHash_row2",
						...
						row2_HashRow.genre_sk = row2.genre_sk;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_1", "\"genre_dim\"", "tMysqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "BbAgim_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "jZRInA_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final genre_movie_bridge genre_movie_bridgeClass = new genre_movie_bridge();

		int exitCode = genre_movie_bridgeClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'genre_movie_bridge' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'genre_movie_bridge' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_Igvm4JGEEe6-v-KvacN3eg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:56:26.370683600Z");
		...
		try {
			...
			java.io.InputStream inContext = genre_movie_bridge.class.getClassLoader()
					.getResourceAsStream("imdb/genre_movie_bridge_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = genre_movie_bridge.class.getClassLoader()
		...
		log.info("TalendJob: 'genre_movie_bridge' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : genre_movie_bridge");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'genre_movie_bridge' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 250885 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 10:56:26 PM GMT-05:00
 ************************************************************************************************/