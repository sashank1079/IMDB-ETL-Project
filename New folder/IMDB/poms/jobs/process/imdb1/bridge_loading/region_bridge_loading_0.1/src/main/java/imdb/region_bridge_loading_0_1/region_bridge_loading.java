...
package imdb.region_bridge_loading_0_1;
...
/**
 * Job: region_bridge_loading Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class region_bridge_loading implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "region_bridge_loading.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(region_bridge_loading.class);
	...
	private final String jobName = "region_bridge_loading";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					region_bridge_loading.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(region_bridge_loading.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_region_bridge_loading = new byte[0];
		static byte[] commonByteArray_IMDB_region_bridge_loading = new byte[0];
		...
		public Integer region_bridge_sk;

		public Integer getRegion_bridge_sk() {
			return this.region_bridge_sk;
		}

		public Boolean region_bridge_skIsNullable() {
			return true;
		}

		public Boolean region_bridge_skIsKey() {
			return true;
		}

		public Integer region_bridge_skLength() {
			return 15;
		}

		public Integer region_bridge_skPrecision() {
			return null;
		}

		public String region_bridge_skDefault() {

			return null;

		}

		public String region_bridge_skComment() {

			return "";

		}

		public String region_bridge_skPattern() {

			return "";

		}

		public String region_bridge_skOriginalDbColumnName() {

			return "region_bridge_sk";
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.region_bridge_sk == null) ? 0 : this.region_bridge_sk.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.region_bridge_sk == null) {
				if (other.region_bridge_sk != null)
					return false;

			} else if (!this.region_bridge_sk.equals(other.region_bridge_sk))
		...
		public void copyDataTo(out1Struct other) {
			...
			other.region_bridge_sk = this.region_bridge_sk;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_region_bridge_loading.length) {
					if (length < 1024 && commonByteArray_IMDB_region_bridge_loading.length == 0) {
						commonByteArray_IMDB_region_bridge_loading = new byte[1024];
					} else {
						commonByteArray_IMDB_region_bridge_loading = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_region_bridge_loading, 0, length);
				strReturn = new String(commonByteArray_IMDB_region_bridge_loading, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_region_bridge_loading, 0, length);
				strReturn = new String(commonByteArray_IMDB_region_bridge_loading, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_region_bridge_loading) {

				try {

					int length = 0;

					this.region_bridge_sk = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.region_bridge_sk, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("region_bridge_sk=" + String.valueOf(region_bridge_sk));
		...
		public String toLogString() {
			...
			if (region_bridge_sk == null) {
				sb.append("<null>");
			} else {
				sb.append(region_bridge_sk);
			}
		...
		public int compareTo(out1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.region_bridge_sk, other.region_bridge_sk);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "otGvnX_" + subJobPidCounter.getAndIncrement());
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`region_bridge_sk` INT(15)  ,`region_sk` INT(10)   not null ,`movie_sk` INT(10)   not null ,`tconst` VARCHAR(10)   not null ,`region` VARCHAR(25)  ,`name` VARCHAR(100)  ,`DI_CreatedDate` DATETIME  not null ,`DI_JobID` VARCHAR(20)   not null ,primary key(`region_bridge_sk`))");
					if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "region_movie_bridge"
						+ "` (`region_bridge_sk`,`region_sk`,`movie_sk`,`tconst`,`region`,`name`,`DI_CreatedDate`,`DI_JobID`) VALUES (?,?,?,?,?,?,?,?)";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.alpha_2 = row1.region;
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.alpha_2 = '" +
							// row2HashKey.alpha_2 + "'");
						} // G 071
...
// # Output table : 'out1'
								...
								out1_tmp.region_bridge_sk = Numeric.sequence("s91", 1, 1);
								out1_tmp.region_sk = row2.region_sk;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (out1.region_bridge_sk == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, out1.region_bridge_sk);
							}

							pstmt_tDBOutput_1.setInt(2, out1.region_sk);

							pstmt_tDBOutput_1.setInt(3, out1.movie_sk);

							if (out1.tconst == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, out1.tconst);
							}

							if (out1.region == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, out1.region);
							}

							if (out1.name == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, out1.name);
							}
							...
							if (out1.DI_JobID == null) {
								...
								pstmt_tDBOutput_1.setString(8, out1.DI_JobID);
							}
...
// ###############################      
	...
	public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.alpha_2 == null) ? 0 : this.alpha_2.hashCode());
		...
		public void readValuesData(DataInputStream dis, org.jboss.marshalling.Unmarshaller objectIn) {
			try {
				...
				this.sub_region = readString(dis, objectIn);
		...
		public void writeValuesData(DataOutputStream dos, org.jboss.marshalling.Marshaller objectOut) {
			try {
				...
				writeString(this.sub_region, dos, objectOut);
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ukKsIi_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `region_dim`.`region_sk`,    `region_dim`.`name`,    `region_dim`.`region`,    `region_dim`.`alpha_2`,    `region_dim`.`sub_region`,    `region_dim`.`DI_CreatedDate`,    `region_dim`.`DI_JobID` FROM `region_dim`\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("false") + ", SCHEMA_COLUMN=" + ("alpha_2") + "}, {TRIM=" + ("false")
									+ ", SCHEMA_COLUMN=" + ("sub_region") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN="
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row2.region_sk = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							row2.region = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row2.alpha_2 = null;
						} else {

							row2.alpha_2 = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row2.sub_region = null;
						} else {

							row2.sub_region = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_1", "\"region_dim\"", "tMysqlInput", "tAdvancedHash_row2",
						...
						row2_HashRow.alpha_2 = row2.alpha_2;

						row2_HashRow.sub_region = row2.sub_region;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_1", "\"region_dim\"", "tMysqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "dS0GnR_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "hB53OX_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final region_bridge_loading region_bridge_loadingClass = new region_bridge_loading();

		int exitCode = region_bridge_loadingClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'region_bridge_loading' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'region_bridge_loading' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_UhRRIJGSEe6-v-KvacN3eg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T04:05:00.308055500Z");
		...
		try {
			...
			java.io.InputStream inContext = region_bridge_loading.class.getClassLoader()
					.getResourceAsStream("imdb/region_bridge_loading_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = region_bridge_loading.class.getClassLoader()
		...
		log.info("TalendJob: 'region_bridge_loading' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : region_bridge_loading");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'region_bridge_loading' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 219311 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 11:05:00 PM GMT-05:00
 ************************************************************************************************/