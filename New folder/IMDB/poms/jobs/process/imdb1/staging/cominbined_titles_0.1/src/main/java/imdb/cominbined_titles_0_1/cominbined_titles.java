...
package imdb.cominbined_titles_0_1;
...
/**
 * Job: cominbined_titles Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class cominbined_titles implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "cominbined_titles.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(cominbined_titles.class);
	...
	private final String jobName = "cominbined_titles";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					cominbined_titles.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(cominbined_titles.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row5Struct implements routines.system.IPersistableRow<row5Struct> {
		final static byte[] commonByteArrayLock_IMDB_cominbined_titles = new byte[0];
		static byte[] commonByteArray_IMDB_cominbined_titles = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_cominbined_titles.length) {
					if (length < 1024 && commonByteArray_IMDB_cominbined_titles.length == 0) {
						commonByteArray_IMDB_cominbined_titles = new byte[1024];
					} else {
						commonByteArray_IMDB_cominbined_titles = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_cominbined_titles, 0, length);
				strReturn = new String(commonByteArray_IMDB_cominbined_titles, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_cominbined_titles, 0, length);
				strReturn = new String(commonByteArray_IMDB_cominbined_titles, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_cominbined_titles) {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ycTMow_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"merged_title_basics\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "merged_title_basics";
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("merged_title_basics")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`tconst` VARCHAR(10)   not null ,`titleType` VARCHAR(255)  ,`primaryTitle` VARCHAR(1024)  ,`originalTitle` VARCHAR(1024)  ,`isAdult` TINYINT(3)  ,`startYear` VARCHAR(4)  ,`endYear` VARCHAR(4)  ,`runtimeMinutes` VARCHAR(10)  ,`genres` VARCHAR(255)  )");
					if (log.isDebugEnabled())
						log.debug("tDBOutput_1 - " + ("Create") + (" table '") + (tableName_tDBOutput_1)
								+ ("' has succeeded."));
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "merged_title_basics"
				...
				runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, 0, 0, "row4", "out1");
					...
					class BytesLimit65535_tDBInput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `imdb_title_basics`.`tconst`,    `imdb_title_basics`.`titleType`,    `imdb_title_basics`.`primaryTitle`,    `imdb_title_basics`.`originalTitle`,    `imdb_title_basics`.`isAdult`,    `imdb_title_basics`.`startYear`,    `imdb_title_basics`.`endYear`,    `imdb_title_basics`.`runtimeMinutes`,    `imdb_title_basics`.`genres` FROM `imdb_title_basics`\"");
							log4jParamters_tDBInput_1.append(" | ");
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"imdb_title_basics\"", "tMysqlInput", "tNormalize_1",
						...
						for (int i_tNormalize_1 = 0; i_tNormalize_1 < lastNoEmptyIndex_tNormalize_1; i_tNormalize_1++) {
							...
							row4.primaryTitle = row1.primaryTitle;
							...
							row4.genres = normalizeRecord_tNormalize_1[i_tNormalize_1];
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row4", "tNormalize_1", "tNormalize_1", "tNormalize", "tUnite_1", "tUnite_1",
									"tUnite"
...
// for output
							...
							row5.tconst = row4.tconst;
							row5.titleType = row4.titleType;
							row5.primaryTitle = row4.primaryTitle;
							row5.originalTitle = row4.originalTitle;
							row5.isAdult = row4.isAdult;
							row5.startYear = row4.startYear;
							row5.endYear = row4.endYear;
							row5.runtimeMinutes = row4.runtimeMinutes;
...
//////////
							...
							if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
									...
									, "row5", "tUnite_1", "tUnite_1", "tUnite", "tDBOutput_1", "mysql_imdb",
									"tMysqlOutput"
							...
							if (row5.tconst == null) {
								...
								pstmt_tDBOutput_1.setString(1, row5.tconst);
							}

							if (row5.titleType == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, row5.titleType);
							}

							if (row5.primaryTitle == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, row5.primaryTitle);
							}

							if (row5.originalTitle == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, row5.originalTitle);
							}

							if (row5.isAdult == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setByte(5, row5.isAdult);
							}

							if (row5.startYear == null) {
								pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(6, row5.startYear);
							}

							if (row5.endYear == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, row5.endYear);
							}

							if (row5.runtimeMinutes == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, row5.runtimeMinutes);
							}

							if (row5.genres == null) {
								pstmt_tDBOutput_1.setNull(9, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(9, row5.genres);
							}
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"imdb_title_basics\"", "tMysqlInput", "tNormalize_1", "tNormalize_1",
						"tNormalize", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"title_basics_stg\"", "tMysqlInput", "tMap_1", "tMap_1",
								"tMap"
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.tconst = row2.tconst;
...
// # Output table : 'out1'
							...
							out1_tmp.titleType = row2.titleType;
							out1_tmp.primaryTitle = row2.primaryTitle;
							out1_tmp.originalTitle = row2.originalTitle;
							out1_tmp.isAdult = row2.isAdult;
							out1_tmp.startYear = row2.startYear;
							out1_tmp.endYear = row2.endYear;
							out1_tmp.runtimeMinutes = row2.runtimeMinutes;
							out1_tmp.genres = row3.genres;
							out1 = out1_tmp;
...
// for output
							...
							row5.titleType = out1.titleType;
							row5.primaryTitle = out1.primaryTitle;
							row5.originalTitle = out1.originalTitle;
							row5.isAdult = out1.isAdult;
							row5.startYear = out1.startYear;
							row5.endYear = out1.endYear;
							row5.runtimeMinutes = out1.runtimeMinutes;
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"title_basics_stg\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "row4", "out1");
				}

				if (enableLogStash) {

					if (runStat.log(resourceMap, iterateId, "row4", 2, 0, "tNormalize_1", "tNormalize_1", "tNormalize",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row5", 2, 0, "tUnite_1",
						"tUnite_1", "tUnite", "tDBOutput_1", "mysql_imdb", "tMysqlOutput", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "yLtZzL_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_3
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_3.append(" | ");
							log4jParamters_tDBInput_3.append("TABLE" + " = " + "\"title_basics_normalized\"");
							log4jParamters_tDBInput_3.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_3", "\"title_basics_normalized\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (colQtyInRs_tDBInput_3 < 2) {
							...
							row3.genres = routines.system.JDBCUtil.getString(rs_tDBInput_3, 2, false);
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_3", "\"title_basics_normalized\"", "tMysqlInput",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_3", "\"title_basics_normalized\"", "tMysqlInput", "tAdvancedHash_row3",
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "bPTkdL_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final cominbined_titles cominbined_titlesClass = new cominbined_titles();

		int exitCode = cominbined_titlesClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'cominbined_titles' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'cominbined_titles' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_d2Us0I-hEe6Qgqt0RnFXeQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-11-30T17:31:33.158849100Z");
		...
		try {
			...
			java.io.InputStream inContext = cominbined_titles.class.getClassLoader()
					.getResourceAsStream("imdb/cominbined_titles_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = cominbined_titles.class.getClassLoader()
		...
		log.info("TalendJob: 'cominbined_titles' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : cominbined_titles");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'cominbined_titles' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 247283 characters generated by Talend Cloud Data Fabric on the 30 November
 * 2023 at 12:31:33 PM GMT-05:00
 ************************************************************************************************/