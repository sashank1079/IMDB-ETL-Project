...
package imdb.actors_combined_0_1;
...
/**
 * Job: actors_combined Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class actors_combined implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "actors_combined.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(actors_combined.class);
	...
	private final String jobName = "actors_combined";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					actors_combined.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(actors_combined.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static void main(String[] args) {
		final actors_combined actors_combinedClass = new actors_combined();

		int exitCode = actors_combinedClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'actors_combined' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'actors_combined' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_vJY2wI5GEe6D8aI9p1Grjw");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-11-28T23:47:18.642160700Z");
		...
		try {
			...
			java.io.InputStream inContext = actors_combined.class.getClassLoader()
					.getResourceAsStream("imdb/actors_combined_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = actors_combined.class.getClassLoader()
		...
		log.info("TalendJob: 'actors_combined' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : actors_combined");
		}
		...
		log.info("TalendJob: 'actors_combined' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 34343 characters generated by Talend Cloud Data Fabric on the 28 November
 * 2023 at 6:47:18 PM GMT-05:00
 ************************************************************************************************/