...
package imdb.principals_dim_0_1;
 ...
 * @status
 */
public class principals_dim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "principals_dim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(principals_dim.class);
	...
	private final String jobName = "principals_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					principals_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(principals_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_principals_dim = new byte[0];
		static byte[] commonByteArray_IMDB_principals_dim = new byte[0];
		...
		public Integer principals_sk;

		public Integer getPrincipals_sk() {
			return this.principals_sk;
		}

		public Boolean principals_skIsNullable() {
			return true;
		}

		public Boolean principals_skIsKey() {
			return true;
		}

		public Integer principals_skLength() {
			return 12;
		}

		public Integer principals_skPrecision() {
			return null;
		}

		public String principals_skDefault() {

			return null;

		}

		public String principals_skComment() {

			return "";

		}

		public String principals_skPattern() {

			return "";

		}

		public String principals_skOriginalDbColumnName() {

			return "principals_sk";
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.principals_sk == null) ? 0 : this.principals_sk.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.principals_sk == null) {
				if (other.principals_sk != null)
					return false;

			} else if (!this.principals_sk.equals(other.principals_sk))
		...
		public void copyDataTo(out1Struct other) {
			...
			other.principals_sk = this.principals_sk;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_principals_dim.length) {
					if (length < 1024 && commonByteArray_IMDB_principals_dim.length == 0) {
						commonByteArray_IMDB_principals_dim = new byte[1024];
					} else {
						commonByteArray_IMDB_principals_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_principals_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_principals_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_principals_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_principals_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_principals_dim) {

				try {

					int length = 0;

					this.principals_sk = readInteger(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.principals_sk, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("principals_sk=" + String.valueOf(principals_sk));
		...
		public String toLogString() {
			...
			if (principals_sk == null) {
				sb.append("<null>");
			} else {
				sb.append(principals_sk);
			}
		...
		public int compareTo(out1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.principals_sk, other.principals_sk);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "HFjs5P_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"principal_dim\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "principal_dim";
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("principal_dim")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`principals_sk` INT(12)  ,`movie_sk` INT(10)   not null ,`person_sk` INT(10)   not null ,`nconst` VARCHAR(10)  ,`tconst` VARCHAR(10)  ,`ordering` INT(10)   not null ,`category` VARCHAR(255)  ,`job` VARCHAR(1024)  ,`DI_CreatedDate` DATETIME  not null ,`DI_JobID` VARCHAR(15)   not null ,primary key(`principals_sk`))");
					if (log.isDebugEnabled())
						log.debug("tDBOutput_1 - " + ("Create") + (" table '") + (tableName_tDBOutput_1)
								+ ("' has succeeded."));
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "principal_dim"
						+ "` (`principals_sk`,`movie_sk`,`person_sk`,`nconst`,`tconst`,`ordering`,`category`,`job`,`DI_CreatedDate`,`DI_JobID`) VALUES (?,?,?,?,?,?,?,?,?,?)";
				...
				try {
					...
					while (rs_tDBInput_3.next()) {
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row2HashKey.nconst = row1.nconst;
						...
						if (tHash_Lookup_row2 != null && tHash_Lookup_row2.getCount(row2HashKey) > 1) { // G 071
							...
							// and it contains more one result from keys : row2.nconst = '" +
							// row2HashKey.nconst + "'");
						} // G 071
...
// # Output table : 'out1'
								...
								out1_tmp.principals_sk = Numeric.sequence("s21", 1, 1);
								out1_tmp.movie_sk = row3.movie_sk;
								out1_tmp.person_sk = row2.person_sk;
								out1_tmp.nconst = row2.nconst;
								out1_tmp.tconst = row3.tconst;
								out1_tmp.ordering = row1.ordering;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (out1.principals_sk == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, out1.principals_sk);
							}

							pstmt_tDBOutput_1.setInt(2, out1.movie_sk);

							pstmt_tDBOutput_1.setInt(3, out1.person_sk);

							if (out1.nconst == null) {
								pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(4, out1.nconst);
							}

							if (out1.tconst == null) {
								pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(5, out1.tconst);
							}

							pstmt_tDBOutput_1.setInt(6, out1.ordering);

							if (out1.category == null) {
								pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(7, out1.category);
							}

							if (out1.job == null) {
								pstmt_tDBOutput_1.setNull(8, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(8, out1.job);
							}
...
// ###############################      
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "leV2hE_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row3.tconst = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row3.primaryTitle = null;
						} else {

							row3.primaryTitle = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row3.originalTitle = null;
						} else {

							row3.originalTitle = routines.system.JDBCUtil.getString(rs_tDBInput_1, 3, false);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row3.startYear = null;
						} else {

							row3.startYear = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row3.endYear = null;
						} else {

							row3.endYear = routines.system.JDBCUtil.getString(rs_tDBInput_1, 5, false);
						}
						if (colQtyInRs_tDBInput_1 < 6) {
							row3.movie_sk = 0;
						} else {

							row3.movie_sk = rs_tDBInput_1.getInt(6);
						...
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							if (rs_tDBInput_1.getString(7) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
									...
									row3.scd_start = rs_tDBInput_1.getTimestamp(7);
								} else {
						...
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							if (rs_tDBInput_1.getString(8) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_1)
										&& !("0000-00-00 00:00:00").equals(dateString_tDBInput_1)) {
									row3.scd_end = rs_tDBInput_1.getTimestamp(8);
								} else {
						...
						if (colQtyInRs_tDBInput_1 < 9) {
							...
							row3.scd_version = rs_tDBInput_1.getInt(9);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							...
							row3.scd_active = rs_tDBInput_1.getBoolean(10);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row3", "tDBInput_1", "\"movie_dim_scd\"", "tMysqlInput", "tAdvancedHash_row3",
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row3", 2, 0,
						"tDBInput_1", "\"movie_dim_scd\"", "tMysqlInput", "tAdvancedHash_row3", "tAdvancedHash_row3",
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "uhxDPu_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_2
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_2.append(" | ");
							log4jParamters_tDBInput_2.append("TABLE" + " = " + "\"person_dim_scd\"");
							log4jParamters_tDBInput_2.append(" | ");
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_2", "\"person_dim_scd\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 3) {
							...
							row2.birthYear = rs_tDBInput_2.getInt(3);
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							row2.person_sk = rs_tDBInput_2.getInt(4);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_2 < 5) {
							...
							if (rs_tDBInput_2.getString(5) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_2)
									...
									row2.scd_start = rs_tDBInput_2.getTimestamp(5);
								} else {
						...
						if (colQtyInRs_tDBInput_2 < 6) {
							...
							if (rs_tDBInput_2.getString(6) != null) {
								...
								if (!("0000-00-00").equals(dateString_tDBInput_2)
										&& !("0000-00-00 00:00:00").equals(dateString_tDBInput_2)) {
									row2.scd_end = rs_tDBInput_2.getTimestamp(6);
								} else {
						...
						if (colQtyInRs_tDBInput_2 < 7) {
							...
							row2.scd_version = rs_tDBInput_2.getInt(7);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_2 < 8) {
							...
							row2.scd_active = rs_tDBInput_2.getBoolean(8);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row2", "tDBInput_2", "\"person_dim_scd\"", "tMysqlInput", "tAdvancedHash_row2",
						...
						row2_HashRow.primaryName = row2.primaryName;

						row2_HashRow.birthYear = row2.birthYear;

						row2_HashRow.person_sk = row2.person_sk;
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row2", 2, 0,
						"tDBInput_2", "\"person_dim_scd\"", "tMysqlInput", "tAdvancedHash_row2", "tAdvancedHash_row2",
						"tAdvancedHash", "output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "OpB4fI_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final principals_dim principals_dimClass = new principals_dim();

		int exitCode = principals_dimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'principals_dim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'principals_dim' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_DVuFwJF_Ee6-v-KvacN3eg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:40:18.013196700Z");
		...
		try {
			...
			java.io.InputStream inContext = principals_dim.class.getClassLoader()
					.getResourceAsStream("imdb/principals_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = principals_dim.class.getClassLoader()
		...
		log.info("TalendJob: 'principals_dim' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : principals_dim");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'principals_dim' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 224335 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 10:40:18 PM GMT-05:00
 ************************************************************************************************/