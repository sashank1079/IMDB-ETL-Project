...
package imdb.directors_dim_0_1;
 ...
 * @status
 */
public class directors_dim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "directors_dim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(directors_dim.class);
	...
	private final String jobName = "directors_dim";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					directors_dim.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(directors_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_directors_dim = new byte[0];
		static byte[] commonByteArray_IMDB_directors_dim = new byte[0];
		...
		public Integer directors_sk;

		public Integer getDirectors_sk() {
			return this.directors_sk;
		}

		public Boolean directors_skIsNullable() {
			return true;
		}

		public Boolean directors_skIsKey() {
			return true;
		}

		public Integer directors_skLength() {
			return null;
		}

		public Integer directors_skPrecision() {
			return null;
		}

		public String directors_skDefault() {

			return null;

		}

		public String directors_skComment() {

			return "";

		}

		public String directors_skPattern() {

			return "";

		}

		public String directors_skOriginalDbColumnName() {
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				result = prime * result + ((this.directors_sk == null) ? 0 : this.directors_sk.hashCode());
		...
		public boolean equals(Object obj) {
			...
			if (this.directors_sk == null) {
				if (other.directors_sk != null)
					return false;

			} else if (!this.directors_sk.equals(other.directors_sk))
		...
		public void copyDataTo(out1Struct other) {
			...
			other.directors_sk = this.directors_sk;
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_directors_dim.length) {
					if (length < 1024 && commonByteArray_IMDB_directors_dim.length == 0) {
						commonByteArray_IMDB_directors_dim = new byte[1024];
					} else {
						commonByteArray_IMDB_directors_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_directors_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_directors_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_directors_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_directors_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_directors_dim) {

				try {

					int length = 0;

					this.directors_sk = readInteger(dis);
					...
					this.DI_CreatedDtae = readDate(dis);
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				writeInteger(this.directors_sk, dos);
				...
				writeDate(this.DI_CreatedDtae, dos);
		...
		public String toString() {
			...
			sb.append("[");
			sb.append("directors_sk=" + String.valueOf(directors_sk));
		...
		public String toLogString() {
			...
			if (directors_sk == null) {
				sb.append("<null>");
			} else {
				sb.append(directors_sk);
			}
		...
		public int compareTo(out1Struct other) {
			...
			returnValue = checkNullsAndCompare(this.directors_sk, other.directors_sk);
			if (returnValue != 0) {
				return returnValue;
			}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "BiLHHQ_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("TABLE" + " = " + "\"directors_dim\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				String tableName_tDBOutput_1 = "directors_dim";
				...
				while (rsTable_tDBOutput_1.next()) {
					...
					if (table_tDBOutput_1.equalsIgnoreCase("directors_dim")) {
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`directors_sk` INT(0)  ,`person_sk` INT(10)   not null ,`movie_sk` INT(10)   not null ,`tconst` VARCHAR(10)  ,`nconst` VARCHAR(10)  ,`DI_CreatedDtae` DATETIME  not null ,`DI_JobID` VARCHAR(15)   not null ,primary key(`directors_sk`))");
					if (log.isDebugEnabled())
						log.debug("tDBOutput_1 - " + ("Create") + (" table '") + (tableName_tDBOutput_1)
								+ ("' has succeeded."));
				}

				String insert_tDBOutput_1 = "INSERT INTO `" + "directors_dim"
						+ "` (`directors_sk`,`person_sk`,`movie_sk`,`tconst`,`nconst`,`DI_CreatedDtae`,`DI_JobID`) VALUES (?,?,?,?,?,?,?)";
...
// ###############################
				...
				cLabel = "\"stg_directors_frm_titlecrew\"";
						...
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBInput_1
									.append("PASS" + " = "
											...
											+ "...");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("TABLE" + " = " + "\"stg_directors_frm_titlecrew\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERYSTORE" + " = " + "\"\"");
							log4jParamters_tDBInput_1.append(" | ");
							log4jParamters_tDBInput_1.append("QUERY" + " = "
									+ "\"SELECT    `stg_directors_frm_titlecrew`.`tconst`,    `stg_directors_frm_titlecrew`.`directors`,    `stg_directors_frm_titlecrew`.`DI_CreatedDate`,    `stg_directors_frm_titlecrew`.`DI_JobID` FROM `stg_directors_frm_titlecrew`\"");
							log4jParamters_tDBInput_1.append(" | ");
							...
							log4jParamters_tDBInput_1.append("TRIM_COLUMN" + " = " + "[{TRIM=" + ("false")
									...
									+ ("directors") + "}, {TRIM=" + ("false") + ", SCHEMA_COLUMN=" + ("DI_CreatedDate")
				...
				if (enableLogStash) {
					talendJobLog.addCM("tDBInput_1", "\"stg_directors_frm_titlecrew\"", "tMysqlInput");
					talendJobLogProcess(globalMap);
				}
				...
				String dbquery_tDBInput_1 = "SELECT \n  `stg_directors_frm_titlecrew`.`tconst`, \n  `stg_directors_frm_titlecrew`.`directors`, \n  `stg_directors_frm_t"
						+ "itlecrew`.`DI_CreatedDate`, \n  `stg_directors_frm_titlecrew`.`DI_JobID`\nFROM `stg_directors_frm_titlecrew`";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"stg_directors_frm_titlecrew\"", "tMysqlInput", "tMap_1",
								"tMap_1", "tMap"
						...
						if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
							...
							row3HashKey.nconst = row1.directors;
						...
						{ // start of Var scope
							...
							Var.DI_CreatedDtae = TalendDate.getCurrentDate();
							Var.DI_JobID = pid;// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'out1'
								...
								out1_tmp.directors_sk = Numeric.sequence("s17", 1, 1);
								out1_tmp.person_sk = row3.person_sk;
								out1_tmp.movie_sk = row2.movie_sk;
								out1_tmp.tconst = row2.tconst;
								out1_tmp.nconst = row3.nconst;
								out1_tmp.DI_CreatedDtae = Var.DI_CreatedDtae;
...
// Start of branch "out1"
						if (out1 != null) {
							...
							if (out1.directors_sk == null) {
								pstmt_tDBOutput_1.setNull(1, java.sql.Types.INTEGER);
							} else {
								pstmt_tDBOutput_1.setInt(1, out1.directors_sk);
							}

							pstmt_tDBOutput_1.setInt(2, out1.person_sk);
							...
							if (out1.nconst == null) {
								...
								pstmt_tDBOutput_1.setString(5, out1.nconst);
							}

							if (out1.DI_CreatedDtae != null) {
								date_tDBOutput_1 = out1.DI_CreatedDtae.getTime();
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"stg_directors_frm_titlecrew\"", "tMysqlInput", "tMap_1", "tMap_1", "tMap",
						"output")) {
					talendJobLogProcess(globalMap);
				}
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "YbK2Kq_" + subJobPidCounter.getAndIncrement());
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "D0vHnW_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "1taRMh_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final directors_dim directors_dimClass = new directors_dim();

		int exitCode = directors_dimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'directors_dim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'directors_dim' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_TZ4t8JF0Ee6-v-KvacN3eg");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:34:52.575187800Z");
		...
		try {
			...
			java.io.InputStream inContext = directors_dim.class.getClassLoader()
					.getResourceAsStream("imdb/directors_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = directors_dim.class.getClassLoader()
		...
		log.info("TalendJob: 'directors_dim' - Started.");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : directors_dim");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'directors_dim' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 210571 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 10:34:52 PM GMT-05:00
 ************************************************************************************************/